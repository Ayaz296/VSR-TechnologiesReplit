...
export function Industries() {
  return (
    <section id="industries" className="py-32 bg-gradient-to-b from-white to-[#EFF6FF] overflow-hidden relative">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-blue-300/15 blur-[120px] pointer-events-none rounded-full" />
          ...
          {industries.map((ind, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-5 sm:p-8 md:p-10 w-full transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                <div className="w-10 sm:w-12 h-1 sm:h-1.5 bg-gradient-to-r from-primary to-cyan-400 mb-3 sm:mb-5 transform origin-left transition-all duration-500 group-hover:w-20 sm:group-hover:w-24"></div>
